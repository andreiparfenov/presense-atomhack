  ...
  <div class="lk">
    <div class="lk-info">
      <div class="lk-info__photo">
        <img src="https://cdn0.iconfinder.com/data/icons/buildings-1/128/40-512.png" alt="me">
      </div>
    ...
    <div class="lk-dashboard">
      ...
      <div class="lk-dashboard__item">
        <div class="lk-dashboard__number">{{user.canceled}}</div>
...
export default {
  ...
  data() {
    return {
      user: {
        name: 'Кофейня "Атом"',
        status: 'Активный предприниматель',
        tasks: 5,
        points: 1600,
        checkTasks: 1,
        canceled: 1,
      ...
      tasks: [
        ...
        },
        {
          ...
          name: 'Установить камеру, чтобы не появлялась свалка',
          desc: 'Необходимо следить за тем, чтобы не было склада мусора. Будем рады содействию местного бизнеса',
          img: require('../assets/video.jpg'),
      ...
      items: [
        {
          id: 0,
          name: 'Покрытие аренды',
          desc: 'Частичное покрытие оплаты аренды за кварки',
          points: 1000
        }
      ],
      bought: false,
